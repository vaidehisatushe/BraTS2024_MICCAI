...
train_data_path = "/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-With-GroundTruth/"
valid_data_path = "/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-ValidationData/"
...
sample_filename = '/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-with-groundtruth/BraTS-GoAT-00000/BraTS-GoAT-00000-t2w.nii.gz'
sample_filename_mask = '/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-with-groundtruth/BraTS-GoAT-00000/BraTS-GoAT-00000-seg.nii.gz'
...
model = keras.models.load_model('mlcube/workspace/additional_files/brain_segmentation_model .h5', custom_objects = {
...
history = pd.read_csv('mlcube/workspace/additional_files/training_per_class.log', sep = ',', engine = 'python')
...
def showPredictsById(case, start_slice = 60):
    path = f"/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-With-GroundTruth/BraTS-GoAT-00{case}"
...
imgs = [nib.load(f"/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-with-groundtruth/BraTS-GoAT-00003/BraTS-GoAT-00003-{m}.nii.gz").get_fdata().astype(np.float32)[:, :, 75] for m in ["t2w", "t1n", "t1c", "t2f"]]
lbl  = nib.load("/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-with-groundtruth/BraTS-GoAT-00003/BraTS-GoAT-00003-seg.nii.gz").get_fdata().astype(np.uint8)[:, :, 75]
...
DATA_PATH = "/mlcube/workspace/data/MICCAI2024-BraTS-GoAT-TrainingData-with-groundtruth/"
